const VideoTitle = ({title, overview}) => {
    return(
        ...
        <p className="py-6 text-lg w-3/2 text-white mb-4">{overview}</p>
        <div>
            <button className="bg-white text-black p-3 px-10 w-15 rounded-md bg-opacity text-center mr-4">
            ...
            <button className="bg-white p-3 px-10 w-15 rounded-md " style={{backgroundColor:"rgba(109, 109, 110, 0.7)"}}>
