const VideoTitle = ({title, overview}) => {
    return(
        <div className="absolute bg-gradient-to-r from-black w-screen aspect-video" style={{padding:"20% 15px 0 15px"}}>
        <h1 className="text-5xl bold text-white mb-5">{title}</h1>
        <p className="py-6 text-lg w-3/5 text-white mb-4">{overview}</p>
        <div>
            <button className="bg-white text-black p-3 px-10 w-15 rounded-md bg-opacity text-center mr-4 hover:bg-opacity-80">
            <svg style={{display:"inline-block", marginRight:"10px"}} xmlns="http://www.w3.org/2000/svg" fill="none" width="24" height="24" viewBox="0 0 24 24" role="img" data-icon="PlayStandard" aria-hidden="true"><path d="M5 2.69127C5 1.93067 5.81547 1.44851 6.48192 1.81506L23.4069 11.1238C24.0977 11.5037 24.0977 12.4963 23.4069 12.8762L6.48192 22.1849C5.81546 22.5515 5 22.0693 5 21.3087V2.69127Z" fill="currentColor"></path></svg>
                Play
            </button>
            <button className="bg-white p-3 px-10 w-15 rounded-md hover:bg-opacity-80" style={{backgroundColor:"rgba(109, 109, 110, 0.7)"}}>
